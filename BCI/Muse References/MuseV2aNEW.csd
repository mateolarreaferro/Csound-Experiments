...
gisaw    ftgen 3, 0, 16384, 10, 1, .2, 0, .4, 0, .6, 0, .8, 0, 1, 0, .8, 0, .6, 0, .4, 0,.2 ;even harmonics
...
ctrlinit 1, 21,0,  1,60,   25,60   ; voice1  
ctrlinit 1, 22,0,  3,15,  26,120  ; voice2
ctrlinit 1, 23,0,  5,12,  27,99   ; voice3
ctrlinit 1, 24,55, 7,60,  28,60   ; voice4
   ...
   kgain2 midic7 22, 0, 1
    kspeed2 midic7 26, .1, 8
     ktrig2  metro kspeed2
       ksize2 midic7 3, 1, 8     
  	     ksend2 midic7 11, 0, 1	
   	      
    kgain3 midic7 23, 0, 1
      kspeed3 midic7 27, .1, 8
       ktrig3  metro kspeed3
         ksize3 midic7 5, 1, 8 
  	       ksend3 midic7 13, 0, 1	     
              
      kgain4 midic7 24, 0, 1 
        kspeed4 midic7 28, .1, 4
          ktrig4   metro kspeed4
            ksize4 midic7 7, 1, 8         
             ksend4 midic7 15, 0, 1	 
 
    agate1 triglinseg ktrig1, 0.5,.5,0
    agate2 triglinseg ktrig2, 0,.1,.3,.1,.2,.2,0
    agate3 triglinseg ktrig3, .5,.6,0
    agate4 triglinseg ktrig4, 0,.1,.4,.1,.3,.3,0
...
aout1 = oscili(0.4*kgain1, (iTrans)*cpsmidinn(kpitch1),2,-1)
 aout2 = oscili(0.4*kgain2, (iTrans)*cpsmidinn(kpitch2),3,-1)
  aout3 = oscili(0.4*kgain3, (iTrans)*cpsmidinn(kpitch3),5,-1)
   aout4 = oscili(0.6*kgain4, (iTrans)*cpsmidinn(kpitch4),4,-1)
   
 aadsr1 madsr .1, 0.4, 0.8, 3.59
  aadsr2 madsr .2, 0.4, 0.9, 3.99
   aadsr3 madsr .1, 0.4, 0.8, 4.59
    aadsr4 madsr .1, 0.4, 0.9, 5.19

aoutL = ((aout1*agate1*aadsr1) + (aout3*agate3*aadsr3))
aoutR = ((aout2*agate2*aadsr2) + (aout4*agate4*aadsr4))
